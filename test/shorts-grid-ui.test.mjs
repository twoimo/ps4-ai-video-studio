...
test("watch feed snaps 9:16 masters and leaves drafts on the grid", async () => {
  ...
  assert.match(css, /\.watch-slide\s*\{[^}]*min-height:\s*var\(--watch-h,\s*100%\)/);
  assert.match(css, /\.watch-slide\s*\{[^}]*max-height:\s*var\(--watch-h,\s*100%\)/);
  ...
  assert.match(css, /\.watch-stage\s*\{[^}]*min-height:\s*var\(--watch-h,\s*100%\)/);
  assert.match(css, /\.watch-stage\s*\{[^}]*max-height:\s*var\(--watch-h,\s*100%\)/);
  ...
  assert.match(css, /\.watch-inspect\s*\{[^}]*height:\s*var\(--watch-h,\s*100%\)/);
  ...
  assert.match(css, /@media \(max-width:\s*860px\)[\s\S]*\.watch-slide[\s\S]*height:\s*var\(--watch-h,\s*100%\)/);
  assert.match(css, /@media \(max-width:\s*860px\)[\s\S]*\.watch-stage[\s\S]*height:\s*var\(--watch-h,\s*100%\)/);
